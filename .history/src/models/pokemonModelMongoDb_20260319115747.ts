...
async function addPokemon(name: string, type: string): Promise<Pokemon> {
    ...
    if (!pokemonsCollection) throw new DatabaseError("Error when adding pokemon - Collection not initialized");
...
async function getSinglePokemon(name: string): Promise<Pokemon> {
    if (!pokemonsCollection) throw new DatabaseError("Error when getting a pokemon - Collection not initialized");
...
async function getAllPokemons(): Promise<Pokemon[]> {
    if (!pokemonsCollection) throw new DatabaseError("Error when getting all pokemon - Collection not initialized");
 ...
 */
async function updatePokemon(name: string, type: string, newName: string, newType: string): Promise<Pokemon> {
    isValid(newName, newType);

    if (!pokemonsCollection) throw new DatabaseError("Error when updating pokemon - Collection not initialized");
...
async function deletePokemon(name: string, type: string): Promise<Pokemon> {
    if (!pokemonsCollection) throw new DatabaseError("Error when deleting pokemon - Collection not initialized");

    try {
        const result = await pokemonsCollection.deleteOne({ name: name, type: type });
